...
def create_model(): 
    try:
        ...
        IMDB = pd.read_csv("C:/Users/harsh/Downloads/movie_booking_system/flask_blog/flaskblog/movie_ratings.csv", sep=',')
        ...
        # Removing useless genres
        # This keeps giving error till run multiple times for some unknown reason so used a while loop.
        flag = 0
        while flag == 0:
            try:
...
def main():
    create_model()
    print("creating_model.py file started and model being created.")
